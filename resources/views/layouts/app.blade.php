                    ...
                    <div class="gap-4 d-flex">
                        <div>
                            ...
                            <ul class="list-unstyled">
                                <li><a href="#" class="link-secondary link-underline link-underline-opacity-0">About</a></li>
                                <li><a href="#" class="link-secondary link-underline link-underline-opacity-0">Product</a></li>
                                <li><a href="#" class="link-secondary link-underline link-underline-opacity-0">Blog</a></li>
                            </ul>
                        </div>
                        <div>
                            <h5>Company</h5>
                            <ul class="list-unstyled">
                                <li><a href="#" class="link-secondary link-underline link-underline-opacity-0">Community</a></li>
                                <li><a href="#" class="link-secondary link-underline link-underline-opacity-0">Career</a></li>
                                <li><a href="#" class="link-secondary link-underline link-underline-opacity-0">Our Story</a></li>
                            </ul>
                        </div>
                        <div>
                            <h5>Contact</h5>
                            <ul class="list-unstyled">
                                <li><a href="#" class="link-secondary link-underline link-underline-opacity-0">Getting Started</a></li>
                                <li><a href="#" class="link-secondary link-underline link-underline-opacity-0">Pricing</a></li>
                                <li><a href="#" class="link-secondary link-underline link-underline-opacity-0">Resources</a></li>
                            </ul>
                        </div>
                    </div>
                </section>
